...
export const NavigationBottom = () => {
  ...
  const colors = ["#FFC700", "#E2E2E2"]; // index 0 active, index 1 inactive
  const activeNavigation = location.pathname;
        ...
        <NavLink to="/">
          ...
          >
            <path
              ...
              fill={activeNavigation == "/" ? colors[0] : colors[1]}
            />
          </svg>
        </NavLink>
        {/* Svg home */}
        ...
        <NavLink to="/orders">
          ...
          >
            ...
            <path
              ...
              stroke={activeNavigation == "/orders" ? colors[0] : colors[1]}
              strokeWidth="2"
            />
            <line
              x1="12"
            ...
            <path
              ...
              fill={activeNavigation == "/orders" ? colors[0] : colors[1]}
            />
          </svg>
        </NavLink>
        {/* Svg order */}
        ...
        <NavLink to="/account">
          ...
          >
            ...
            <path
              ...
              stroke={activeNavigation == "/account" ? colors[0] : colors[1]}
              strokeWidth="2"
            />
            <circle
              cx="16"
