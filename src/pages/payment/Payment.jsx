        ...
        <div className="mt-6 bg-white px-6 py-4">
          ...
          <div className="mt-2 flex justify-between">
            ...
            <p className="text-sm text-black">
              IDR {formatCurrency(food.price * quantity)}
            </p>
          </div>
          <div className="mt-2 flex justify-between">
            <p className="text-sm text-brand-secondary">Driver</p>
            <p className="text-sm text-black">IDR {formatCurrency(50000)}</p>
          </div>
          <div className="mt-2 flex justify-between">
            <p className="text-sm text-brand-secondary">Tax 10%</p>
            <p className="text-sm text-black">
              IDR {formatCurrency((10 / 100) * (food.price * quantity))}
            </p>
          </div>
          <div className="mt-2 flex justify-between">
            <p className="text-sm text-brand-secondary">Total Price</p>
            <p className="text-sm text-blue-400">
              IDR {formatCurrency((10 / 100) * (food.price * quantity) + 50000)}
            </p>
          </div>
        </div>
        <div className="mt-6 bg-white px-6 py-4">
